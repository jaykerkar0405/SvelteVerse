<script lang="ts">
	...
	import VideoRoom from '$lib/components/video-room.svelte';
	import { Video, Key, ArrowRight, Sparkles } from 'lucide-svelte';
			...
			<Card class="relative overflow-hidden p-8 shadow-lg">
				...
				<div class="relative">
					<div class="mb-8 text-center">
						...
						<h1 class="text-3xl font-bold tracking-tight">Join Video Room</h1>
						<p class="mt-2 text-sm text-muted-foreground">
							Connect directly with others through secure peer-to-peer video chat
						</p>
					</div>
					<div class="space-y-6">
						<div class="space-y-2">
